...
<span style="color: red">WARNING: This behavior is chosen to be least likely to cause data loss, though _that is still possible_. You're using git, right?</span>

---
Note: Yes, polling is not that efficient, but it is very simple. This could be improved at some point if required using chokidar or similar, but this is not a performance critical tool and the complexity isn't currently justified.
